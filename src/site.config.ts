...
const config: SiteConfig = {
  ...
  tags: ['Astro', 'Blog', 'Rust', 'Typescript', 'Squared X'],
  ...
  socialLinks: {
    github: 'https://github.com/hex42',
    twitter: 'https://x.com/flakylawww',
